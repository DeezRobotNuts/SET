...
def verglijk(self, kaart2, kaart3):
    if self.verglijk_nummer(self, kaart2 ,kaart3) and self.verglijk_symbool(kaart2, kaart3) and self.verglijk_kleur(kaart2, kaart3) and self.verglijk_shading(kaart2, kaart3):
        return True
    else:
        return False
